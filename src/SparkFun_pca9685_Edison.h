...
class pca9685
{
  public:
    ...
    // Custom Functions:
    // Sets four motors to the same PWM dc
    void setFourMotors(float throttle) ;
    // Inverts and scales the pwm output
    float invertAndScale(float throttle ) ;
    ...
    //Custom Function in this Class
    float incrementBasePWM(float base) ;
